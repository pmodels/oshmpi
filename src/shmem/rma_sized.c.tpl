...
{
    OSHMPI_ctx_get_nbi(ctx, MPI_TYPE, SIZE, dest /* origin_addr */ ,
                       source /* target_addr */ , nelems, pe);
}
...
{
    OSHMPI_ctx_iput(ctx, MPI_TYPE, OSHMPI_AM_MPI_TYPE, source /* origin_addr */ ,
                    dest /* target_addr */ , dst, sst, nelems, pe);
}

void shmem_putSIZENAME_nbi(void *dest, const void *source, size_t nelems, int pe)
{
    OSHMPI_ctx_put_nbi(SHMEM_CTX_DEFAULT, MPI_TYPE, SIZE, source /* origin_addr */ ,
                       dest /* target_addr */ , nelems, pe);
}
...
void shmem_ctx_putSIZENAME_nbi(shmem_ctx_t ctx, void *dest, const void *source,
                               size_t nelems, int pe)
{
    OSHMPI_ctx_put_nbi(ctx, MPI_TYPE, SIZE, source /* origin_addr */ ,
                       dest /* target_addr */ , nelems, pe);
}
/* TPL_BLOCK_END */